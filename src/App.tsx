...
const SONGS: SongEntry[] = [
  { title: 'answer me',               artist: 'Imie',                          url: 'https://piapro.jp/t/6W2N/20251215164617', options: { video: { lyricId: 126519, lyricDiffId: 28626 } } },
  { title: 'After the curtain',       artist: 'Rulmry',                        url: 'https://piapro.jp/t/zoqO/20251214200738', options: { video: { lyricId: 126591, lyricDiffId: 28627 } } },
  { title: 'Shutter Chance',          artist: 'Yamiagari',                     url: 'https://piapro.jp/t/PNpQ/20251209170719', options: { video: { lyricId: 126542, lyricDiffId: 28628 } } },
  { title: 'The last march on earth', artist: 'Natsuyama Yotsugi × Dopam!ne', url: 'https://piapro.jp/t/B3yJ/20251215061727', options: { video: { lyricId: 126594, lyricDiffId: 28629 } } },
  { title: 'Toritsukulogy',           artist: 'Tsuruzou',                      url: 'https://piapro.jp/t/QBdL/20251215094303', options: { video: { lyricId: 126593, lyricDiffId: 28630 } } },
  { title: 'Takeover',                artist: 'Twinfield',                     url: 'https://piapro.jp/t/E2i3/20251215092113', options: { video: { lyricId: 126533, lyricDiffId: 28631 } } },
]
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const checkReady = () => {
      if (videoReadyRef.current && timerReadyRef.current && !disposed) setIsLoaded(true)
    }
    ...
    p.addListener({
      onAppReady() { /* song is loaded on demand via handleSelectSong */ },
  ...
  return (
    <div id="app-root">
      ...
      <div id="app-content">
        {page === 'maze' && <Maze />}
        {page === 'dino' && selectedSongIdx === null && (
          <div className="song-picker">
            <h2 className="song-picker__title">SELECT A SONG</h2>
            <ul className="song-picker__list">
              {SONGS.map((s, i) => (
                <li key={i}>
                  <button className="song-picker__item" onClick={() => handleSelectSong(i)}>
                    <span className="song-picker__num">{String(i + 1).padStart(2, '0')}</span>
